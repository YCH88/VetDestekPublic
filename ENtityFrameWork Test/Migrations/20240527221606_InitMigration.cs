        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsForSpesificBreeds = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BreedDiseases", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BreedDiseases_Breeds_BreedId",
                        column: x => x.BreedId,
                        principalTable: "Breeds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BreedDiseases_Diseases_DiseaseId",
                        column: x => x.DiseaseId,
                        principalTable: "Diseases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnimalDiseases_AnimalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BreedDiseases_BreedId",
                table: "BreedDiseases",
                column: "BreedId");

            migrationBuilder.CreateIndex(
                name: "IX_BreedDiseases_DiseaseId",
                table: "BreedDiseases",
                column: "DiseaseId");
